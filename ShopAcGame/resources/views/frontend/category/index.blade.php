                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                <div class="news_image">
                                    ...
                                    <a href="{{route('frontend.sub_category.index', 'nick-lien-quan')}}" title="Danh Mục Game Free Fire" class="">
                                        <img src="img/danhmuc.gif" alt="Danh Mục Game Free Fire"></a>
                                </div>
                                <div class="news_title">
                                    <h2>
                                        <a href="{{route('frontend.sub_category.index', 'nick-lien-quan')}}" title="Danh Mục Game Liên Quân">Danh Mục Game Liên Quân</a>
                                    </h2>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="custom72 view">
                                                <a href="{{route('frontend.sub_category.index', 'nick-lien-quan')}}" class="" title="Danh Mục Game Liên Quân">
                                                    &nbsp;
                                                    <style type="text/css">
                                                        .custom72{
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                <div class="news_image">
                                    ...
                                    <a href="{{route('frontend.sub_services.index', 'cay-thue-lien-quan')}}" title="Danh Mục Game Free Fire" class="">
                                        <img src="{{asset('frontend')}}/assets/img/danhmuc.gif" alt="Danh Mục Game Free Fire"></a>
                                </div>
                                <div class="news_title">
                                    <h2>
                                        <a href="{{route('frontend.sub_services.index', 'cay-thue-lien-quan')}}" title="Danh Mục Game Free Fire">Danh Mục Game Free Fire</a>
                                    </h2>
                                </div>
                                <div class="news_description">
                                    <p>
