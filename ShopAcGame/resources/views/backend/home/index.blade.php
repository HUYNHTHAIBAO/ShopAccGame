                        ...
                        <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                                ...
                                <li class="breadcrumb-item text-gray-700 fw-bold lh-1">
                                    <a href="index-2.html" class="text-gray-500">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="{{asset('backend')}}/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="{{asset('backend')}}/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="{{asset('backend')}}/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="{{asset('backend')}}/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Cody Fishers</a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="{{asset('backend')}}/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
                                                                    <span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="py-10 text-center">
                                            <img src="{{asset('backend')}}/assets/media/svg/illustrations/easy/2.svg" class="theme-light-show w-200px" alt=""/>
                                            <img src="{{asset('backend')}}/assets/media/svg/illustrations/easy/2-dark.svg" class="theme-dark-show w-200px" alt=""/>
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                                    <!--end::Heading-->
                                ...
                                <div class="card-body pt-4">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{asset('backend')}}/assets/media/stock/ecommerce/210.gif" class="w-50px" alt=""/>
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{asset('backend')}}/assets/media/stock/ecommerce/215.gif" class="w-50px" alt=""/>
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{asset('backend')}}/assets/media/stock/ecommerce/209.gif" class="w-50px" alt=""/>
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{asset('backend')}}/assets/media/stock/ecommerce/214.gif" class="w-50px" alt=""/>
                                                </td>
                                                <td class="ps-0">
