...
<head>
    ...
    <meta property="og:title" content="Saul HTML Pro - Bootstrap 5 HTML Multipurpose Admin Dashboard Theme"/>
    <meta property="og:url" content="https://keenthemes.com/products/saul-html-pro"/>
    <meta property="og:site_name" content="Keenthemes | Saul HTML Pro"/>
    <link rel="canonical" href="https://preview.keenthemes.com/saul-html-pro"/>
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        Jane Cooper <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                                    </div>
                ...
                >
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><i
                                ...
                                class="menu-title">Admin</span><span class="menu-arrow"></span></span>
        ...
        <div class="card-body position-relative" id="kt_app_layout_builder_body">
            ...
            <div id="kt_app_settings_content"
                ...
                <form class="form" method="POST" id="kt_app_layout_builder_form"
                      action="https://preview.keenthemes.com/saul-html-pro/index.php">
                            ...
                            <div class="row " data-kt-buttons="true"
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        ...
                                        <div class="form-check-wrapper border-gray-200 border-2">
                                            <img src="{{asset('backend')}}/assets/media/preview/light.png"
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper border-gray-200 border-2">
                                            <img src="{{asset('backend')}}/assets/media/preview/dark.png"
                                                 class="mw-100 mh-250px" alt=""/>
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Check-->
                        ...
                        <div class="form-group d-flex flex-stack">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <div
                                    ...
                                    <input class="form-check-input w-45px h-30px" type="checkbox" checked value="true"
                                           name="layout-builder[layout][app][aside][display]" id="kt_builder_aside"/>
                                    <!--begin::Label-->
...
>
    <i class="ki-duotone ki-setting-4 fs-4 me-1"></i> Tùy chỉnh giao diện
</button>
            ...
            <div class="card-toolbar">
                ...
                <div class="me-0">
                    <button class="btn btn-sm btn-icon btn-active-color-primary" data-kt-menu-trigger="click"
                            data-kt-menu-placement="bottom-end">
                        <i class="ki-duotone ki-dots-square fs-2"><span class="path1"></span><span class="path2"></span><span
            ...
            <div
                ...
                <div class="rounded border border-dashed border-gray-300 py-6 px-8 mb-5">
                    ...
                    <div class="d-flex flex-column flex-center mb-3">
                        ...
                        <div class="mb-2">
                            <img src="{{asset('backend')}}/assets/media/svg/payment-methods/paypal.svg" alt=""
                                 class="h-30px me-3 rounded-1"/>
                            <img src="{{asset('backend')}}/assets/media/svg/payment-methods/visa.svg" alt=""
                                 class="h-30px me-3 rounded-1"/>
                            <img src="{{asset('backend')}}/assets/media/svg/payment-methods/mastercard.svg" alt=""
                                 class="h-30px me-3 rounded-1"/>
                            <img src="{{asset('backend')}}/assets/media/svg/payment-methods/americanexpress.svg" alt=""
                ...
                <a href="https://preview.keenthemes.com/html/saul-html-pro/docs/getting-started/changelog"
                   class="parent-hover d-flex align-items-center mb-7">
                    ...
                    <div
                        ...
                        <i class="ki-duotone ki-keyboard text-danger fs-2x fs-lg-3x"><span class="path1"></span><span
                                class="path2"></span></i>
                    </div>
                    <!--end::Icon-->
                    <!--begin::Info-->
                                    ...
                                    <div class="row mb-2" data-kt-buttons="true">
                                        ...
                                        <div class="col">
                                            ...
                                            <label
                                                ...
                                                <input type="radio" class="btn-check" name="account_team_size" checked
                                                       value="2-10"/>
                                 ...
                                 <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                                          ...
                                          <span
                                              class="fw-bold text-gray-800 text-hover-primary fs-5">Company Account</span>
                                          <span
                                              class="fs-6 fw-semibold text-muted">Use images to enhance your post flow</span>
                                          </span>
                                                <!--end:Description-->
                                       </span>
                                            <!--end:Label-->
                                       ...
                                       <input class="form-check-input" type="radio" name="account_plan" value="1"/>
                                        ...
                                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                                          ...
                                          <span class="d-flex flex-column">
                                          <span
                                              class="fw-bold text-gray-800 text-hover-primary fs-5">Developer Account</span>
                                          <span class="fs-6 fw-semibold text-muted">Use images to your post time</span>
                                            ...
                                            <!--begin:Input-->
                                            <span class="form-check form-check-custom form-check-solid">
                                       <input class="form-check-input" type="radio" checked name="account_plan"
                                              value="2"/>
                                       </span>
                                            <!--end:Input-->
                                        </label>
                                        ...
                                        <label class="d-flex flex-stack mb-0 cursor-pointer">
                                          ...
                                          <span class="d-flex flex-column">
                                          <span
                                              class="fw-bold text-gray-800 text-hover-primary fs-5">Testing Account</span>
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                            ...
                                            <img src="{{asset('backend')}}/assets/media/svg/card-logos/mastercard.svg"
                                                 alt="" class="h-25px"/>
                                            <img
                                                src="{{asset('backend')}}/assets/media/svg/card-logos/american-express.svg"
                                                alt="" class="h-25px"/>
                                        </div>
                                        <!--end::Card logos-->
                                    </div>
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1 ">
                                            ...
                                            <div class=" fw-semibold">
                                                ...
                                                <div class="fs-6 text-gray-700 ">To start using great tools, please, <a
                                                        href="utilities/wizards/vertical.html" class="fw-bold">Create
                                                        Team Platform</a>
                                                </div>
                                            </div>
                                            <!--end::Content-->
                                        ...
                                        <div class="fv-row">
                                          ...
                                          <input class="form-check-input" type="radio" name="category" value="2"/>
                                            ...
                                            <label class="d-flex flex-stack cursor-pointer">
                                             ...
                                             <span
                                                 class="fs-7 text-muted">Creating a clear text structure copywriting</span>
                                             </span>
                                                    <!--end:Info-->
                                          </span>
                                                <!--end:Label-->
                                    ...
                                    <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span
                                       ...
                                       <input class="form-check-input" type="radio" name="framework" value="2"/>
                                        ...
                                        <label class="d-flex flex-stack cursor-pointer mb-5">
                                          ...
                                          <span class="symbol symbol-50px me-6">
                                          <span class="symbol-label bg-light-danger">
                                          <i class="ki-duotone ki-angular fs-2x text-danger"><span class="path1"></span><span
                                                  class="path2"></span><span class="path3"></span></i>                        </span>
                                          </span>
                                                <!--end:Icon-->
                                                <!--begin:Info-->
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="{{asset('backend')}}/assets/media/svg/card-logos/visa.svg"
                                                     alt="" class="h-25px"/>
                                                <img
                                                    src="{{asset('backend')}}/assets/media/svg/card-logos/mastercard.svg"
                                                    alt="" class="h-25px"/>
                                                <img
                                                    src="{{asset('backend')}}/assets/media/svg/card-logos/american-express.svg"
                                                    alt="" class="h-25px"/>
